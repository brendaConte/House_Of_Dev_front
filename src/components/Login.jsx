    ...
    <div className=" h-screen w-full ">
      <div className=" flex min-h-full flex-col justify-center px-8 py-8 lg:px-8 ">
        <form
          ...
          className="card-float container mx-auto w-80 justify-center"
        >
          <div className="flex flex-row rounded">
            <div className="p-12 md:p-24 bg-[#FE4236] justify-center">
              <HodLogo />
              <div className="mt-0 flex flex-col space-y-4 text-center bg-[#FE4236] text-white mt-5 text-center">
                <input
                ...
                <p>
                  ...
                  <button
                    type="submit"
                    className=" px-4 font-semibold leading-6 text-[#123AC8] hover:text-indigo-600 	;"
                  >
